...
! function (e, t) {
    ...
    function y(e, t, n, r, i) {
        ...
        for (f.textContent = "", d = 0; o = p[d++];)
            ...
            else if (l = se.contains(o.ownerDocument, o), a = v(f.appendChild(o), "script"), l && m(a), n)
    ...
    function D(e, t, r, i) {
        ...
        if (p && (o = y(t, e[0].ownerDocument, !1, e, i), a = o.firstChild, 1 === o.childNodes.length && (o = a), a || i)) {
            ...
            if (u)
                for (c = s[s.length - 1].ownerDocument, se.map(s, k), f = 0; f < u; f++) l = s[f], Ie.test(l.type || "") && !Ne.access(l, "globalEval") && se.contains(c, l) && (l.src ? se._evalUrl && se._evalUrl(l.src) : n(l.textContent.replace(Qe, ""), c))
        }
        return e
    }
    ...
    function $(e, t, n) {
        ...
        for (function (e, t) {
            ...
            if (r = $.prefilters[o].call(l, e, c, l.opts)) return se.isFunction(r.stop) && (se._queueHooks(l.elem, l.opts.queue).stop = se.proxy(r.stop, r)), r;
    ...
    se.fn = se.prototype = {
        ...
        var e, t, n, r, i, o, a = arguments[0] || {},
            ...
            u = arguments.length,
            l = !1;
        for ("boolean" == typeof a && (l = a, a = arguments[s] || {}, s++), "object" == typeof a || se.isFunction(a) || (a = {}), s === u && (a = this, s--); s < u; s++)
            if (null != (e = arguments[s]))
                for (t in e) n = a[t], a !== (r = e[t]) && (l && r && (se.isPlainObject(r) || (i = Array.isArray(r))) ? (i ? (i = !1, o = n && Array.isArray(n) ? n : []) : o = n && se.isPlainObject(n) ? n : {}, a[t] = se.extend(l, o, r)) : void 0 !== r && (a[t] = r));
        return a
    }, se.extend({
                    ...
                    if (n = w.relative[e[s].type]) c = [h(g(c), n)];
                        ...
                        if ((n = w.filter[e[s].type].apply(null, e[s].matches))[M]) {
                            ...
                            return m(s > 1 && g(c), s > 1 && d(e.slice(0, s - 1).concat({
                                value: " " === e[s - 2].type ? "*" : ""
                            })).replace(oe, "$1"), n, s < r && y(e.slice(s, r)), r < i && y(e = e.slice(r)), r < i && d(e))
                        }
                        c.push(n)
                    }
                return g(c)
            ...
            return p.prototype = w.filters = w.pseudos, w.setFilters = new p, E = t.tokenize = function (e, n) {
                ...
                if (n = n || [], 1 === c.length) {
                    ...
                    for (i = fe.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !w.relative[s = a.type]);)
                        if ((u = w.find[s]) && (r = u(a.matches[0].replace(me, ye), ve.test(o[0].type) && f(t.parentNode) || t))) {
    ...
    (se.fn.init = function (e, t, n) {
        ...
        if (n = n || ye, "string" == typeof e) {
            ...
            if (r[1]) {
                if (t = t instanceof se ? t[0] : t, se.merge(this, se.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : Y, !0)), ve.test(r[1]) && se.isPlainObject(t))
    ...
    f.uid = 1, f.prototype = {
        ...
        remove: function (e, t) {
            ...
            if (void 0 !== r) {
                if (void 0 !== t) {
                    n = (t = Array.isArray(t) ? t.map(se.camelCase) : (t = se.camelCase(t)) in r ? [t] : t.match(Te) || []).length;
                    for (; n--;) delete r[t[n]]
    ...
    se.event = {
        ...
        add: function (e, t, n, r, i) {
            ...
            if (v)
                for (n.handler && (n = (o = n).handler, i = o.selector), i && se.find.matchesSelector(Be, i), n.guid || (n.guid = se.guid++), (u = v.events) || (u = v.events = {}), (a = v.handle) || (a = v.handle = function (t) {
                    return void 0 !== se && se.event.triggered !== t.type ? se.event.dispatch.apply(e, arguments) : void 0
                }), l = (t = (t || "").match(Te) || [""]).length; l--;) d = g = (s = Xe.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = se.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = se.event.special[d] || {}, c = se.extend({
                    type: d,
                    origType: g,
                    data: r,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, o), (p = u[d]) || ((p = u[d] = []).delegateCount = 0, f.setup && !1 !== f.setup.call(e, r, h, a) || e.addEventListener && e.addEventListener(d, a)), f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), i ? p.splice(p.delegateCount++, 0, c) : p.push(c), se.event.global[d] = !0)
        },
        remove: function (e, t, n, r, i) {
            var o, a, s, u, l, c, f, p, d, h, g, v = Ne.hasData(e) && Ne.get(e);
            if (v && (u = v.events)) {
                for (l = (t = (t || "").match(Te) || [""]).length; l--;)
                    if (s = Xe.exec(t[l]) || [], d = g = s[1], h = (s[2] || "").split(".").sort(), d) {
            ...
            if (u && l.nodeType && !("click" === e.type && e.button >= 1))
                for (; l !== this; l = l.parentNode || this)
                    if (1 === l.nodeType && ("click" !== e.type || !0 !== l.disabled)) {
                        for (o = [], a = {}, n = 0; n < u; n++) void 0 === a[i = (r = t[n]).selector + " "] && (a[i] = r.needsContext ? se(i, this).index(l) > -1 : se.find(i, this, null, [l]).length), a[i] && o.push(r);
                        o.length && s.push({
                            elem: l,
                            handlers: o
                        })
    ...
    se.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(ae.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || se.isXMLDoc(e)))
                for (a = v(s), r = 0, i = (o = v(e)).length; r < i; r++) N(o[r], a[r]);
            if (t)
                if (n)
    ...
    se.extend({
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = se.camelCase(t),
                    u = tt.test(t),
                    l = e.style;
                if (u || (t = L(s)), a = se.cssHooks[t] || se.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : l[t];
                "string" == (o = typeof n) && (i = Le.exec(n)) && i[1] && (n = d(e, t, i), o = "number"), null != n && n == n && ("number" === o && (n += i && i[3] || (se.cssNumber[s] ? "" : "px")), ae.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u ? l.setProperty(t, n) : l[t] = n))
            }
        },
        ...
        se.cssHooks[t] = {
            ...
            set: function (e, n, r) {
                var i, o = r && Ze(e),
                    a = r && F(e, t, r, "border-box" === se.css(e, "boxSizing", !1, o), o);
        ...
        if (t) return (parseFloat(A(e, "marginLeft")) || e.getBoundingClientRect().left - Oe(e, {
            marginLeft: 0
        }, function () {
    ...
    se.Animation = se.extend($, {
        ...
        prefilters: [function (e, t, n) {
            ...
            if ((u = !se.isEmptyObject(t)) || !se.isEmptyObject(d)) {
                ...
                for (r in d) u || (m ? "hidden" in m && (v = m.hidden) : m = Ne.access(e, "fxshow", {
                    display: l
    ...
    se.fn.extend({
        ...
        toggleClass: function (e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : se.isFunction(e) ? this.each(function (n) {
                ...
                var t, r, i, o;
                if ("string" === n)
                    for (r = 0, i = se(this), o = e.match(Te) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
                else void 0 !== e && "boolean" !== n || ((t = _(this)) && Ne.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : Ne.get(this, "__className__") || ""))
            })
        },
        hasClass: function (e) {
            var t, n, r = 0;
            for (t = " " + e + " "; n = this[r++];)
                if (1 === n.nodeType && (" " + B(_(n)) + " ").indexOf(t) > -1) return !0;
            return !1
        }
    });
    var ht = /\r/g;
    ...
    se.extend(se.event, {
        trigger: function (t, n, r, i) {
            var o, a, s, u, l, c, f, p = [r || Y],
                d = re.call(t, "type") ? t.type : t,
                h = re.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = s = r = r || Y, 3 !== r.nodeType && 8 !== r.nodeType && !gt.test(d + se.event.triggered) && (d.indexOf(".") > -1 && (d = (h = d.split(".")).shift(), h.sort()), l = d.indexOf(":") < 0 && "on" + d, t = t[se.expando] ? t : new se.Event(d, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : se.makeArray(n, [t]), f = se.event.special[d] || {}, i || !f.trigger || !1 !== f.trigger.apply(r, n))) {
                ...
                for (o = 0;
                    (a = p[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? u : f.bindType || d, (c = (Ne.get(a, "events") || {})[t.type] && Ne.get(a, "handle")) && c.apply(a, n), (c = l && a[l]) && c.apply && Se(a) && (t.result = c.apply(a, n), !1 === t.result && t.preventDefault());
    ...
    Lt.href = vt.href, se.extend({
        ...
        ajax: function (t, n) {
            function r(t, n, r, s) {
                ...
                }(h, b, C, l), l ? (h.ifModified && ((w = C.getResponseHeader("Last-Modified")) && (se.lastModified[o] = w), (w = C.getResponseHeader("etag")) && (se.etag[o] = w)), 204 === t || "HEAD" === h.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = b.state, p = b.data, l = !(d = b.error))) : (d = T, !t && T || (T = "error", t < 0 && (t = 0))), C.status = t, C.statusText = (n || T) + "", l ? m.resolveWith(g, [p, T, C]) : m.rejectWith(g, [C, T, d]), C.statusCode(x), x = void 0, f && v.trigger(l ? "ajaxSuccess" : "ajaxError", [C, h, l ? p : d]), y.fireWith(g, [C, T]), f && (v.trigger("ajaxComplete", [C, h]), --se.active || se.event.trigger("ajaxStop")))
            }
    ...
    ae.cors = !!Ft && "withCredentials" in Ft, ae.ajax = Ft = !!Ft, se.ajaxTransport(function (t) {
        ...
        if (ae.cors || Ft && !t.crossDomain) return {
            send: function (i, o) {
                ...
                n = function (e) {
                    return function () {
                        n && (n = r = s.onload = s.onerror = s.onabort = s.onreadystatechange = null, "abort" === e ? s.abort() : "error" === e ? "number" != typeof s.status ? o(0, "error") : o(s.status, s.statusText) : o(Ht[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
                            binary: s.response
                        } : {
                                text: s.responseText
    ...
    se.ajaxSetup({
        ...
        var i, o, a, s = !1 !== t.jsonp && (Pt.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Pt.test(t.data) && "data");
        ...
        var r, i, o;
        return t || (ae.createHTMLDocument ? ((r = (t = Y.implementation.createHTMLDocument("")).createElement("base")).href = Y.location.href, t.head.appendChild(r)) : t = Y), i = ve.exec(e), o = !n && [], i ? [t.createElement(i[1])] : (i = y([e], t, o), o && o.length && se(o).remove(), se.merge([], i.childNodes))
        ...
        setOffset: function (e, t, n) {
            var r, i, o, a, s, u, l = se.css(e, "position"),
                c = se(e),
                f = {};
...
/*!
 * eByte Crowdsale v1.2.0 (https://www.ebyte.sale/)
 * Copyright 2018 eByte Development Team
 */
"use strict";
...
function convertToLocaleString(e) {
    return e.toLocaleString(language)
}
$(document).ready(function () {
    function e(a) {
        var s = $(".crowdsale-content");
        s.removeClass("hidden"), o(w, s.find(".crowdsale-countdown"), function () {
            s.addClass("hidden"), a < 3 ? e(a++) : t()
        }, !0),
            function (e) {
                n(e)
            }(s)
    ...
    function t() {
        var e = $(".after-crowdsale-content");
        e.removeClass("hidden"), n(e)
    }

    function n(e) {
        var t = e.find(".progress");
        t.find(".privatepresale").css("left", 115 / l * 100 + "%"), t.find(".softCapTimeline").css("left", l / l * 100 + "%"), t.find(".hardCapTimeline").css("left", "98.5%"), t.find(".softCapTimeline").css("left", "98.5%"), t.find(".soft-cap").text(l.toLocaleString(language) + " ETH "), t.find(".hard-cap").text(d.toLocaleString(language) + " ETH "), e.find(".conversion .rate").text(p), e.find(".conversion .bonus").text((p * u).toFixed(2)), e.find(".bonus-heading").text((100 * u).toFixed(0) + "%");
        var n = !1;
        if ($.getJSON("https://api.newalchemy.io/sales/ebyte/contributions", function (t) {
            n = !0;
            for (var o = 0; o < t.amounts.length; o++) {
                var s = t.amounts[o].split(" "),
                    d = +s[0];
                if ("ETH" === s[1]) {
                    var u = ((a = d) + 115 + 25) / l * 100;
                    i = (a + 25) * p, $(".raised-eth").text((a + 115 + 25).toLocaleString(language)), $(".sold-ebytes").text(i.toFixed(0).toLocaleString(language)), $(".available-ebytes").text(Math.round(c - i).toLocaleString(language)), $.getJSON("https://api.etherscan.io/api?module=stats&action=ethprice", function (e) {
                        $(".raised-usd").text(((a + 115 + 25) * e.result.ethusd).toFixed(2).toLocaleString(language) + " USD")
                    }), $.getJSON("https://api.etherscan.io/api?module=account&action=txlist&address=" + r + "&sort=asc&apikey=4ZH9IRJK6PHE4PCRURF3CFR58ZJXES39PU", function (e) {
                        var t = e.result.length;
                        $(".numTrans").text((t - 2 + 43).toLocaleString(language)), a > 0 && $(".avgContribution").text((a / t).toFixed(2) + " ETH")
                    }), e.find(".progress .progress-bar").css("width", u + .5 + "%"), e.find(".progress .progress-end-wrapper").css("width", u + "%");
                    var h = e.find(".progress .counter");
                    u > 70 ? (h.parent().css("right", "40px"), h.text((a + 115 + 25).toFixed(1))) : (h.parent().css("right", "-210px"), h.text((a + 115 + 25).toFixed(1)));
                    break
                }
            }
        }), !n) {
            var o = ((a = 0) + 115 + 25) / l * 100;
            i = (a + 25) * p, $(".raised-eth").text((a + 115 + 25).toLocaleString(language)), $(".sold-ebytes").text(i.toFixed(0).toLocaleString(language)), $(".available-ebytes").text(Math.round(c - i).toLocaleString(language)), $.getJSON("https://api.etherscan.io/api?module=stats&action=ethprice", function (e) {
                $(".raised-usd").text(((a + 115 + 25) * e.result.ethusd).toFixed(2).toLocaleString(language) + " USD")
            }), $.getJSON("https://api.etherscan.io/api?module=account&action=txlist&address=" + r + "&sort=asc&apikey=4ZH9IRJK6PHE4PCRURF3CFR58ZJXES39PU", function (e) {
                var t = e.result.length;
                $(".numTrans").text((t - 2 + 43).toLocaleString(language)), a > 0 && $(".avgContribution").text((a / t).toFixed(2) + " ETH")
            }), e.find(".progress .progress-bar").css("width", o + .5 + "%"), e.find(".progress .progress-end-wrapper").css("width", o + "%");
            var s = e.find(".progress .counter");
            o > 70 ? (s.parent().css("right", "40px"), s.text((a + 115 + 25).toFixed(1))) : (s.parent().css("right", "-210px"), s.text((a + 115 + 25).toFixed(1)))
        }
    }
    ...
    function o(e, t, n, o) {
        function s() {
            var s = new Date,
                ...
                g = 0,
                m = 0;
            u < 0 || o && a >= d ? (clearInterval(p), "function" == typeof n && n()) : (h = Math.floor(u / c), f = Math.floor(u % c / l), g = Math.floor(u % l / r), m = Math.floor(u % r / i)), t.find(".days").html(h), t.find(".hours").html(f), t.find(".minutes").html(g), t.find(".seconds").html(m)
        }
        var e = new Date(e),
            i = 1e3,
            r = 60 * i,
    ...
    var a, s = !1,
        i = 0,
        r = "0x60206c079d4bb1778bba9bcab2554aabb0c81a6a",
        l = 2e3,
        d = 7300,
        c = 28e4,
        p = 38,
        ...
        f = 18,
        g = 600,
        m = new Date(Date.UTC(2018, 7, 31, 21, 59, 59)),
        S = new Date(Date.UTC(2018, 8, 15, 0, 0, 0)),
        b = new Date(Date.UTC(2018, 10, 1, 0, 0, 0)),
        w = new Date(Date.UTC(2018, 8, 15, 0, 0, 0));
    ! function () {
        var a = new Date;
        $(".full-pre-sale-content").addClass("hidden"), a > w ? t() : a > b ? e(3) : a > S ? e(2) : a > m ? e(1) : function () {
            var t = $(".full-pre-sale-content");
            t.removeClass("hidden"), o(m, t.find(".crowdsale-countdown"), function () {
                $(".full-pre-sale-content").addClass("hidden"), e(1)
            }), n(t)
        }()
    }(), $.getJSON("https://api.etherscan.io/api?module=stats&action=ethprice", function (e) {
        var t = e.result.ethusd || g,
            n = $("table.token-sale-plan"),
            o = n.find(".pre-sale"),
            a = n.find(".ico1"),
            s = n.find(".ico2"),
            i = n.find(".ico"),
            r = $("ul.crowdsale-details");
        r.find(".hard-cap").html("30,000 ETH"), r.find(".soft-cap").html("2,000 ETH"), o.find(".hard-cap").html(Math.round(504e4 / t).toLocaleString(language) + " ETH"), a.find(".hard-cap").html(Math.round(18e5 / t).toLocaleString(language) + " ETH"), s.find(".hard-cap").html(Math.round(18e5 / t).toLocaleString(language) + " ETH"), i.find(".hard-cap").html(Math.round(11808e3 / t).toLocaleString(language) + " ETH"), o.find(".price").html("1 ETH = " + Math.round(t / f * 1.3) + " EBYTE"), a.find(".price").html("1 ETH = " + Math.round(t / f * 1.2) + " EBYTE"), s.find(".price").html("1 ETH = " + Math.round(t / f * 1.1) + " EBYTE"), i.find(".price").html("1 ETH = " + Math.round(t / f) + " EBYTE")
    }), $.getJSON("https://www.ebyte.sale/scripts/getCountryCode.php", function (e) {
        -1 !== ["US", "CN"].indexOf(e.countryCode) && (s = !0, $(".newsletter button").attr("disabled", !0), $(".newsletter input").attr("disabled", !0).val("Your country is excluded from the sale."))
    }), $(".converter .eth, .converter .ebyte").on("input", function () {
        var e = $(this),
            t = parseFloat(e.val()),
            n = $(".converter"),
            o = n.find(".eth"),
            a = n.find(".ebyte");
        isNaN(t) ? e.hasClass("eth") ? a.val("") : e.hasClass("ebyte") && o.val("") : e.hasClass("eth") ? a.val(t * h) : e.hasClass("ebyte") && o.val(t / h)
    ...
    }), $('form[name="newsletter-registration"]').on("submit", function (e) {
        function t(e, t) {
            var n = $(".newsletter .response");
            n.prev().addClass("hidden"), n.removeClass("hidden"), "success" === t ? n.find(".text-success").removeClass("hidden") : n.find(".text-danger").removeClass("hidden"), setTimeout(function () {
                $(".affix, .affix-top").addClass("hidden")
            }, 2e3)
        }
        e.preventDefault();
        var n = $(e.target),
            o = n.find("input").val();
        emailIsValid(o) ? (n.find("button").attr("disabled", !0), $.ajax({
            type: "POST",
            url: "https://www.ebyte.cash/api/v1/crowdsale/newsletter",
            data: {
                email: o
            },
            success: t,
            ...
            crossDomain: !0,
            dataType: "html"
        }), "function" == typeof ga && ga("send", "event", "Crowdsale-Newsletter-Registration", "submit")) : alert("Please enter a valid e-mail adress.")
    }), $(".ico-reg-btn").click(function () {
        $.tokenSaleModalsClosed = !1, $(".blur-wrapper").addClass("show-blur"), s ? $("#tokenSaleStepForbidden").modal("show") : $("#tokenSaleStep0").modal("show")
    }), $(".intro-section-new .ico-reg-btn").click(function () {
        "function" == typeof ga && ga("send", "event", "tokenSaleStep0", "open", "HeaderButton")
    }), $(".affix-newsletter .ico-reg-btn").click(function () {
        "function" == typeof ga && ga("send", "event", "tokenSaleStep0", "open", "AffixButton")
    }), $("#tokenSaleAcceptStepForbidden").on("click", function () {
        $("#tokenSaleStepForbidden").modal("hide")
    }), $("#tokenSaleAcceptStep0").on("click", function () {
        "function" == typeof ga && ga("send", "event", "Help", "continue"), $("#tokenSaleStep0").modal("hide")
    }), $("#tokenSaleAcceptStep1").on("click", function () {
        var e = $("#tokenSaleFormStep1"),
            t = $(e).find('input[name="conditions"]:checked'),
            n = $(e).find(".accept-conditions");
        4 === t.length ? ($("#gRecaptcha").children().length ? grecaptcha.reset() : grecaptcha.render("gRecaptcha", {
            sitekey: "6Lc_NCkUAAAAAOLvS3kvq3wFuq_z5-ZaJd1nnfVR"
        }), n.addClass("hidden"), "function" == typeof ga && ga("send", "event", "Terms", "continue"), $("#tokenSaleStep1").modal("hide")) : n.removeClass("hidden")
    }), $("#tokenSaleAcceptStep2").on("click", function () {
        var e = $("#tokenSaleFormStep2"),
            t = e.find('input[name="email"]').val().trim(),
            n = grecaptcha.getResponse(),
            o = $(e).find(".invalid-email"),
            a = $(e).find(".unsolved-captcha"),
            s = !0;
        emailIsValid(t) ? o.addClass("hidden") : (o.removeClass("hidden"), s = !1), "" !== n ? a.addClass("hidden") : (a.removeClass("hidden"), s = !1), s && ($("#tokenSaleAcceptStep2").attr("disabled", !0), $.ajax({
            type: "POST",
            url: "https://www.ebyte.cash/api/v1/crowdsale/registration",
            data: {
                email: t,
                gRecaptcha: n
            },
            dataType: "json",
            success: function () {
                "function" == typeof ga && ga("send", "event", "tokenSaleStep2", "finish"), $("#tokenSaleStep2").modal("hide"), $("#tokenSaleAcceptStep2").attr("disabled", !1)
            },
            error: function (e) {
                alert(e.responseJSON.message), "function" == typeof ga && ga("send", "event", "tokenSaleStep2", "hide", "ERROR"), $("#tokenSaleAcceptStep2").attr("disabled", !1)
            }
        }))
    }), $("#tokenSaleAcceptStep3").on("click", function () {
        "function" == typeof ga && ga("send", "event", "RealSale", "continue"), $("#tokenSaleStep3").modal("hide")
    }), $("#tokenSaleAcceptStep4").on("click", function () {
        "function" == typeof ga && ga("send", "event", "SaleOverlay", "close"), $(".blur-wrapper").removeClass("show-blur"), $("#tokenSaleStep4").modal("hide")
    }), $("#copyTokenSaleWalletAddressToClipboard").on("click", function () {
        var e = $("<input>");
        $("#copyTokenSaleWalletAddressToClipboard").append(e), "function" == typeof ga && ga("send", "event", "copiedAddress", "continue"), e.val($("#tokenSaleWalletAddress").text().trim()).select(), document.execCommand("copy"), e.remove(), $(".copied-wallet-address").removeClass("hidden")
    }), $("#tokenSaleStepForbidden").on("hidden.bs.modal", function (e) {
        $(".blur-wrapper").removeClass("show-blur")
    }), $("#tokenSaleStep0").on("hidden.bs.modal", function (e) {
        $.tokenSaleModalsClosed ? ("function" == typeof ga && ga("send", "event", "tokenSaleStep0", "abort"), $(".blur-wrapper").removeClass("show-blur")) : $("#tokenSaleStep1").modal("show")
    }), $("#tokenSaleStep1").on("hidden.bs.modal", function (e) {
        $.tokenSaleModalsClosed ? ("function" == typeof ga && ga("send", "event", "tokenSaleStep1", "abort"), $(".blur-wrapper").removeClass("show-blur")) : $("#tokenSaleStep3").modal("show")
    }), $("#tokenSaleStep2").on("hidden.bs.modal", function (e) {
        $.tokenSaleModalsClosed ? ("function" == typeof ga && ga("send", "event", "tokenSaleStep2", "abort"), $(".blur-wrapper").removeClass("show-blur")) : $("#tokenSaleStep3").modal("show")
    }), $("#tokenSaleStep3").on("hidden.bs.modal", function (e) {
        $.tokenSaleModalsClosed ? ("function" == typeof ga && ga("send", "event", "tokenSaleStep3", "abort"), $(".blur-wrapper").removeClass("show-blur")) : $("#tokenSaleStep4").modal("show")
    }), $("#tokenSaleStep4").on("hidden.bs.modal", function (e) {
        $(".blur-wrapper").removeClass("show-blur"), $("#tokenSaleStep4").modal("hide")
    }), $('[data-toggle="tooltip"]').tooltip(), $(".page-scroll").click(function () {
    ...
    new LazyLoad({
        elements_selector: ".technology-section"
    }), drawCharts()
